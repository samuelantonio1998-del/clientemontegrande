...
const translations = {
  pt: {
    ...
    weekdayMealRule: "Cada refeição = 10 pontos · 4 refeições/semana = 10€ desconto · 200 pontos = buffet grátis (só dias úteis)",
    ...
    buffetRedeemHint: "Válido apenas em dias úteis (segunda a sexta) — peça ao staff para aplicar",
  ...
  en: {
    ...
    weekdayMealRule: "Each meal = 10 points · 4 meals/week = 10€ discount · 200 points = free buffet (weekdays only)",
    ...
    buffetRedeemHint: "Valid only on weekdays (Mon–Fri) — ask staff to apply",
