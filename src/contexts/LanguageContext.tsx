...
const translations = {
  pt: {
    ...
    buffetAvailable: "Buffet Disponível",
    buffetRedeemHint: "Peça ao staff para aplicar o seu buffet",
    buffetRedeemed: "Buffet aplicado com sucesso!",
    buffet200Active: "Buffet grátis ativo",
    redeemBuffet: "Aplicar Buffet",
    confirmBuffet: "Aplicar buffet grátis?",
    confirmBuffetMsg: "Serão deduzidos 200 pontos e o buffet será aplicado. Esta ação não pode ser revertida.",
  ...
  en: {
    ...
    buffetAvailable: "Buffet Available",
    buffetRedeemHint: "Ask staff to apply your buffet",
    buffetRedeemed: "Buffet applied successfully!",
    buffet200Active: "Free buffet active",
    redeemBuffet: "Apply Buffet",
    confirmBuffet: "Apply free buffet?",
    confirmBuffetMsg: "200 points will be deducted and the buffet will be applied. This action cannot be undone.",
