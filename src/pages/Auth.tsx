        ...
        {!forgotPassword && (
          <>
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="font-mono text-xs text-muted-foreground uppercase tracking-wider">ou</span>
              <div className="flex-1 h-px bg-foreground/20" />
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-card text-foreground font-mono text-xs uppercase tracking-[0.2em] border-2 border-foreground flex items-center justify-center gap-2 hover:bg-muted transition-colors"
            >
